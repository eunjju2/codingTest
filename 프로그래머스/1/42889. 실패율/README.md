...
> 배열 정렬을 한 뒤에 인덱스에 어떻게 접근해야 할지 몰라서 고민하다 새 배열을 만들고 또 반복문을 돌면서 해결하긴 했는데, `Object.entries` 를 쓰면 되는 거였다 ,, 새로운 거 알아가기 !


### 성능 요약

메모리: 79.6 MB, 시간: 8811.19 ms
