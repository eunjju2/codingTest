...
### 🌀재풀이
>단순히 indexOf과 slice를 while로 반복 사용하려 했으나 스택을 활용하는게 더 효율적이었던 것 ..! '110'이 빠지고 나서 새로 생기는 '110'을 어떻게 처리할 것인가 고민했는데 스택을 활용하면 됐었다. **자료구조** 잘 활용하기 !!! <br>
그리고 사전순 나열을 어떻게 할 것인가는, '110'은 1로 시작하니 0 뒤로 가는게 최선일 것이다. 따라서 마지막 0의 인덱스를 찾고 그 뒤에 삽입하면 비교 연산 필요 없이 최적의 수를 구할 수 있었다.
